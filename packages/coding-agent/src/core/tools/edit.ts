...
import type { theme as interactiveTheme } from "../../modes/interactive/theme/theme.js";
...
function formatEditCall(args: RenderableEditArgs | undefined, theme: typeof interactiveTheme): string {
