...
let photonModule: typeof PhotonModule | null = null;
let loadPromise: Promise<typeof PhotonModule | null> | null = null;
 ...
 */
export async function loadPhoton(): Promise<typeof PhotonModule | null> {
	if (photonModule) {
		return photonModule;
	}
