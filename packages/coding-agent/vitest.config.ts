...
const aiSrcLivePricing = fileURLToPath(new URL("../ai/src/live-pricing.ts", import.meta.url));
...
export default defineConfig({
	...
	resolve: {
		alias: [
			...
			{ find: /^@earendil-works\/pi-ai\/live-pricing$/, replacement: aiSrcLivePricing },
